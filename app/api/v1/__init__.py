...
from . import cars, participants, addresses, available_cars, photos, streets, type_work_children, type_work_parents, work_shop, price
...
router.include_router(price.router, prefix="/v1")